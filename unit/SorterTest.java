...
public class SorterTest {
	...
	@Test public void testSortAscending() {
		assertEquals(new int[]{1, 2, 3}, sorter.sortAscending(new int[]{1, 2, 3})); // Test sorting an already sorted array
		assertEquals(new int[]{1, 2, 3}, sorter.sortAscending(new int[]{3, 2, 1})); // Test sorting a reversed array
		assertEquals(new int[]{1, 2, 3, 5, 9}, sorter.sortAscending(new int[]{9, 1, 5, 3, 2})); // Test sorting an arbitrary array
	}

	// Test cases for sortDescending method
	@Test public void testSortDescending() {
		assertEquals(new int[]{3, 2, 1}, sorter.sortDescending(new int[]{3, 2, 1})); // Test sorting an already sorted array in descending order
		assertEquals(new int[]{3, 2, 1}, sorter.sortDescending(new int[]{1, 2, 3})); // Test sorting an ascending array in descending order
		assertEquals(new int[]{9, 5, 3, 2, 1}, sorter.sortDescending(new int[]{1, 2, 3, 5, 9})); // Test sorting an arbitrary array in descending order
	}
	...
	@Test public void testFindMin() {
		...
		assertEquals(1, sorter.findMin(new int[]{5, 4, 3, 2, 1, 6, 7, 8, 1, 9})); // Test finding the min of an arbitrary array
	}
	...
	@Test public void testFindSum() {
		...
		assertEquals(15, sorter.findSum(new int[]{3, 2, 1, 6, 7, 8, 1, 5, 4, 5})); // Test finding the sum of an arbitrary array
	}
}
