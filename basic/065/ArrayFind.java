...
class ArrayFind {
	...
	/**
	 * Method to find the first value within a specified range in an array.
	 * This method iterates through the elements of the input array up to a specified length and returns the first value
	 * that falls within the given range (inclusive of 'from' and 'to'). If no value within the range is found in the
	 ...
	 * @param length   The number of elements from the start of the array to consider for the search.
	 *                 If the length is greater than the array length, the method will consider the entire array.
	 *                 If the array is empty, or if the length is zero, the 'notFound' value is returned.
	 * @param from     Start of the range (inclusive).
	 * @param to       End of the range (inclusive).
	 * @param notFound Value to return if no value within the specified range is found in the considered portion of the array.
	 * @return The first value found in the specified range within the first 'length' elements of the array, or 'notFound'
	 *         if no such value is found. The range includes both 'from' and 'to' values.
	 */
