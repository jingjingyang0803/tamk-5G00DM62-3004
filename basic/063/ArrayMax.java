...
class ArrayMax {
	 ...
	 * This method iterates through the elements of the input array up to a specified length and finds the maximum value.
	 *
	 * @param array  Input array of integers. It should not be null, and should have at least one element.
	 * @param length The number of elements from the start of the array to consider for finding the maximum value.
	 ...
	 * @return The maximum value among the first 'length' elements of the array. If 'length' is greater than the actual
	 *         array length, it returns the maximum value in the entire array.
	 */
